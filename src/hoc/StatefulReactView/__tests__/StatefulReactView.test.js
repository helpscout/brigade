...
import {COMPONENT_UPDATED} from '../StatefulReactView'
import {StatefulReactView} from '../index'
import Backbone from 'backbone'
import Marionette from 'backbone.marionette'
import {destroyRegion, makeRegion} from '../../../util/regionHelpers'

//TODO make these tests real! They are just a copy of ReactView.test.js
...
describe('StatefulReactView tests', () => {
  ...
  beforeEach(() => {
    ...
    onShow = jest.fn()
    onClose = jest.fn()
    ComponentView = StatefulReactView(
  ...
  describe('Error handling', () => {
    ...
    test('should warn when used on a non-ItemView', () => {
      const CollectionView = StatefulReactView(
